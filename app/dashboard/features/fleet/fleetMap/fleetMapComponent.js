...
var FleetMapComponent = (function () {
    ...
    // call Here map
    FleetMapComponent.prototype.callHereMap = function (loc) {
    ...
    FleetMapComponent.prototype.calculateRoute = function (map, platform) {
        var origin = [49.8951,
            -97.1384];
        var destination = [49.2827,
            -123.1207];
        var waypoint = [50.4452, -104.6189];
    ...
    ], FleetMapComponent.prototype, "fleetLocation", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], FleetMapComponent.prototype, "fleetEventLocation", void 0);
    FleetMapComponent = __decorate([
        core_1.Component({
            //moduleId: module.id,
            selector: 'fleetMap',
...
exports.FleetMapComponent = FleetMapComponent;
