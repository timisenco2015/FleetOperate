...
var FleetGeneralComponent = (function () {
    // constructor to loop the products in product service file and disply in html
    function FleetGeneralComponent() {
        this.showMap = false;
    }
    // render something initially 
    FleetGeneralComponent.prototype.ngOnInit = function () {
    };
    // render fleet general info on constant changes
    FleetGeneralComponent.prototype.ngOnChanges = function () {
        var _this = this;
    ...
    ], FleetGeneralComponent.prototype, "truckData", void 0);
    FleetGeneralComponent = __decorate([
        core_1.Component({
            selector: 'fleet-general',
            templateUrl: 'app/dashboard/features/fleet/fleetGeneral/fleetGeneralTemplate.html',
        }), 
        __metadata('design:paramtypes', [])
    ], FleetGeneralComponent);
    return FleetGeneralComponent;
}());
exports.FleetGeneralComponent = FleetGeneralComponent;
