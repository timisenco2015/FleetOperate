...
var UserSetNewPasswordService = (function () {
    function UserSetNewPasswordService(_http, appService, router) {
        this._http = _http;
        this.appService = appService;
        this.router = router;
    }
    UserSetNewPasswordService.prototype.extractData = function (response) {
        var serverResponse = response;
        return serverResponse || {};
    };
    UserSetNewPasswordService.prototype.handleError = function (error) {
        console.error("Error:" + error);
        return Observable_1.Observable.throw(error.json().error || "Server error");
    };
    UserSetNewPasswordService.prototype.getAppClientInfo = function (userData) {
    ...
    UserSetNewPasswordService.prototype.confirmUser = function (confirmUserData) {
    ...
    UserSetNewPasswordService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, app_service_1.AppService, router_1.Router])
    ], UserSetNewPasswordService);
    return UserSetNewPasswordService;
}());
exports.UserSetNewPasswordService = UserSetNewPasswordService;
//# sourceMappingURL=userSetNewPasswordService.js.map